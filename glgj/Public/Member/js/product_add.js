$(function() {
                ...
                editor3.plugin.multiImageDialog({
                    clickFn : function(urlList) {
                        ...
                        K.each(urlList, function(i, data) {
                            temp.append('<div class="img_wrap"><img class="delete_img" src="' + imgUrl + '/delete_img.png" width="20" height="20" /><img src="' + data.url + '" width="160" height="100" /><input value="' + data.url + '" name="allpic[]" type="hidden" /></div>');
                        });
                        $('.delete_img').click(function() {
                            $(this).parents('.img_wrap').remove();
                        });
    ...
    $('#spec_add').click(function() {
        ...
        _html += '<li class="w84"><input class="i50 spec_buymin" type="text" name="spec[buymin][]" value="1" /></li>';
    ...
    $('body').on('click', '.spec_copy', function() {
        ...
        _html += '<li class="w84"><input class="i50 spec_buymin" type="text" name="spec[buymin][]" value="' + liObj.eq(i+2).find('input').val() + '" /></li>';
