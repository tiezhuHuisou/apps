...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./Public/App/css/list_source.css"/>
</head>
<body>
...
<section class="viewport">
    ...
    <?php if(!empty($list)): ?><div class="list_wrap">
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="?g=app&m=member&a=publishGoods&id=<?php echo ($vo["id"]); ?>">
                    <div class="mgt10 weui-form-preview">
                        ...
                        <div class="weui-form-preview__bd">
                            <div class="weui-form-preview__item">
                                <label class="weui-form-preview__label">货物名称：</label>
                                <span class="weui-form-preview__value"><?php echo ($vo["name"]); ?></span>
                            </div>

                            <div class="weui-form-preview__item">
                                <label class="weui-form-preview__label">货物信息：</label>
                                <span class="weui-form-preview__value"><?php echo ($vo["category_id"]); ?></span>
                            </div>
                            <div class="weui-form-preview__item">
                                <label class="weui-form-preview__label">运输方式:</label>
                                <span class="weui-form-preview__value"><?php echo ($vo["transport_id"]); ?></span>
                            </div>
                        </div>
                    </div>
...
<!-- 可视区域 结束 -->
<!-- 底部 开始 -->
<a class="editor_footer" href="?g=app&m=member&a=publishGoods">新增货源</a>
<!-- 底部 结束 -->
...
<script type="text/javascript" src="./Public/App/js/list_source.js"></script>
</body>
</html>