...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./Public/App/css/truckList.css"/>
</head>
<body>
<!-- 头部 -->
<header>
...
<!-- 无底部区域 -->
<?php if(!empty($list['ordered'])): ?><section class="no_footer">
        <!-- 列表页 -->
        <div class="news_list">
                            ...
                            <div class="weui-panel__bd">
                                <div href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
                                    ...
                                    <div class="weui-media-box__bd">
                                        <h4 class="weui-media-box__title"><?php echo ($vo['start']); ?>--<?php echo ($vo['end']); ?></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="weui-panel__bd">
                                <div href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
                                    <div class="weui-media-box__bd">
                                        <p class="weui-media-box__desc">
                                            <span class="phone">车辆类型：<?php echo ($vo['truck_type']); ?></span>
                                        </p>
                                        <p class="weui-media-box__desc">车牌号码：<?php echo ($vo['truck_no']); ?></p>
                                        <p class="weui-media-box__desc">车辆信息：<?php echo ($vo['source_type']); ?>
                                            <?php echo ($vo['heavy']); echo ($vo['heavy_unit']); ?></p>
                                    </div>
...
<?php if(empty($list)): ?><!-- 收藏为空时 -->
    <div class="collect_empty_wrap ">
        <div class="common_empty" style="display: none;">
            ...
            <a href="?g=app&m=product&a=truckList">去收藏</a>
        </div>
    </div><?php endif; ?>
</section>
<footer>
...
<script type="text/javascript" src="./Public/App/js/truckList.js"></script>
</body>
</html>