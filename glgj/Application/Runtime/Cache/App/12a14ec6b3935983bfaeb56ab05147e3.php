...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./Public/App/css/depotList.css"/>
</head>
<body>
<!-- 头部 -->
<header>
        ...
        <div class="news_list">
            ...
            <ul>
                <?php if(is_array($list['ordered'])): $i = 0; $__LIST__ = $list['ordered'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <div class="unselected_icon" data-id="<?php echo ($li["id"]); ?>"></div>
                        <div class="weui-cell__bd">
                            <div class="weui-panel__bd">
                                <div href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
                                    <!--<div class="weui-media-box__hd">-->
                                    <!--<img class="weui-media-box__thumb" src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1487755060639&di=d98a0789aa9467f900a1364a63624a18&imgtype=0&src=http%3A%2F%2Ff.hiphotos.baidu.com%2Fzhidao%2Fpic%2Fitem%2Fadaf2edda3cc7cd960628dc03901213fb80e9158.jpg">-->
                                    <!--</div>-->
                            ...
                            <div class="weui-panel__bd">
                                <div href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
                                    <div class="weui-media-box__bd">
                                        <p class="weui-media-box__desc">仓库信息：<?php echo ($vo['area']); ?> 平方米</p>
                                        <p class="weui-media-box__desc">仓库类型：<?php echo ($vo['standard']); ?></p>
                                    </div>
...
<script type="text/javascript" src="./Public/App/js/depotList.js"></script>
</body>
</html>