...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./Public/App/css/editor_truck.css"/>
</head>
<body>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="mgt10 weui-cells weui-cells_checkbox">
                    <div class="weui-cell">
                        <label class="weui-cell__hd">
                            <input type="checkbox" class="js_check_single weui-check" name="checkbox1" data-id="<?php echo ($vo["id"]); ?>">
                            <i class="weui-icon-checked"></i>
                        </label>
                        <!--<a href="?g=app&m=member&a=publishTruck&id=<?php echo ($vo["id"]); ?>">-->
...
<script type="text/javascript" src="./Public/App/js/editor_truck.js"></script>
</body>
</html>