...
<body>
	...
	<div class="main">
		<div class="wrapper">
			...
			<div class="header">
				<h2>省市区管理中心</h2>
				<a href="?g=admin&m=news&a=circlecategory">省市区列表</a>
				<a class="hover" href="?g=admin&m=news&a=circlecategoryadd">添加省市区</a>
			</div>
            <h3><?php echo ($opt); ?>省市区</h3>
            <!-- 主体数据 -->
            <form class="form-horizontal chkform" name="" action="" method="post">
                <table class="add_table">
                    ...
                    <tr>
                        <td class="w120">名称：</td>
                        <td>
                            <input class="i200" name="name" type="text" value="<?php echo ($detail["name"]); ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td class="w120">上级区域：</td>
                        <td>
                            <select id="issue_author" class="pl3" name="parent">
                                <option value="">请选择上级区域</option>
                                <?php if(is_array($regions)): $i = 0; $__LIST__ = $regions;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($vo["id"]) == $detail["parent"]): ?>selected<?php endif; ?>><?php echo ($vo['sty']); echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </td>
                    </tr>
                    <!-- 是否显示 -->
