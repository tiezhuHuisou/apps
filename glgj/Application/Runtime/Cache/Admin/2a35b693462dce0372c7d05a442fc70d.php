...
<body>
    ...
    <!-- 主体 开始 -->
    <div class="main">
    <input id="url" type="hidden" value="?g=admin&m=member&a=company_category_delall">
        <div class="wrapper">
            <!-- 主体头部 -->
            <div class="header">
                <h2>企业分组管理中心</h2>
                <a class="hover" href="?g=admin&m=member&a=company_group">企业分组列表</a>
                <a href="?g=admin&m=member&a=company_group_add">添加企业分组</a>
            </div>
            <!-- 主体数据 -->
            <table class="data">
                <!-- 数据头部 -->
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        ...
                        <span>(id:<span><?php echo ($li["id"]); ?></span>)</span>
                    </td>
                    <td><img src="<?php echo ($li["logo"]); ?>" width="50" height="50" /></td>
                    <td><?php echo ($li["sort"]); ?></td>
                    <td class="data_opt">
                        <a href="?g=admin&m=member&a=company_group_add&id=<?php echo ($li["id"]); ?>">修改</a>
                        <a class="confirm ajax-get" href="index.php?g=admin&m=member&a=company_category_del&id=<?php echo ($li["id"]); ?>">删除</a>
                    </td>
                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
            </table>
            <!-- 操作 -->
            <div class="opt">
                <a class="opt_btn" href="?g=admin&m=member&a=company_group_add">添加</a>
