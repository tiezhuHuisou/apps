...
<body>
	...
	<div class="main">
		<div class="wrapper">
			...
			<div class="header">
				<h2>更多管理中心</h2>
				<!-- <a class="hover" href="?g=admin&m=more">单页列表</a>
				<a href="?g=admin&m=more&a=add">添加单页</a>
				<a href="?g=admin&m=more&a=add">自定义单页</a> -->
			</div>
			<!-- 主体数据 -->
			<table class="data">
				<!-- 数据头部 -->
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><tr>
					...
					<!-- <td class="tl"><?php echo ($li["linkid"]); ?></td>
					<td><?php echo (date("Y-m-d H:i",$li["inputtime"])); ?></td> -->
					<td class="data_opt">
						<a href="?g=admin&m=more&a=add&id=<?php echo ($li["id"]); ?>">修改</a>
						<!-- <a class="confirm ajax-get" href="index.php?g=admin&m=more&a=del&id=<?php echo ($li["id"]); ?>">删除</a> -->
					</td>
