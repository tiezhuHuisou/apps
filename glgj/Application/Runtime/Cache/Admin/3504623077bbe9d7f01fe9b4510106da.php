...
<div class="main">
    ...
    <div class="wrapper">
        ...
        <div class="header">
            <h2>网点管理中心</h2>
            <a class="hover" href="?g=admin&m=member&a=point&id=<?php echo ($_GET['id']); ?>">网点管理</a>
            <a href="?g=admin&m=member&a=pointAdd&cid=<?php echo ($_GET['id']); ?>">添加网点</a>
        ...
        <table class="data">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><tr>
                    <td><input class="check_box" type="checkbox" name="items" value="<?php echo ($li["p_id"]); ?>"/></td>
                    <td><?php echo ($li["p_id"]); ?></td>
                    <td><?php echo ($li["p_title"]); ?></td>
                    <td><?php echo ($li["p_name"]); ?></td>
                    <td><?php echo ($li["p_mobile"]); ?></td>
                    <td><?php echo ($li["address"]); ?></td>
                    <td><?php echo ($li["p_addtime"]); ?></td>
                    <td class="data_opt">
                        <a href="?g=admin&m=member&a=pointAdd&pid=<?php echo ($li["p_id"]); ?>">修改</a>
                        <a class="confirm ajax-get" href="index.php?g=admin&m=member&a=pointDel&id=<?php echo ($li["p_id"]); ?>">删除</a>
                    </td>
                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
        </table>
        <!-- 操作 -->
        <div class="opt">
            <a class="opt_btn" href="?g=admin&m=member&a=pointAdd&ids=<?php echo ($_GET['id']); ?>">添加</a>
