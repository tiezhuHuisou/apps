...
<script type="text/javascript" src="./Public/static/js/check.js"></script>
	...
	<script type="text/javascript" src="./Public/Admin/js/notice_add.js"></script>
</head>
<body>
	<!-- 顶部 开始 -->
	<div class="top">
	...
	<div class="main">
		<div class="wrapper">
			...
			<div class="header">
				<h2>公告管理中心</h2>
				<a href="?g=admin&m=news&a=notice">公告列表</a>
				<a class="hover" href="?g=admin&m=news&a=notice_add">添加公告</a>
			</div>
            <h3>添加公告</h3>
            <!-- 主体数据 -->
            <form class="form-horizontal chkform" name="" action="" method="post" >
                ...
                <table class="add_table">
                    ...
                    <tr>
                        <td class="w120">标题：</td>
                        <td>
                            <input class="i400" name="title" type="text" value="<?php echo ($detail["title"]); ?>" datatype="title" nullmsg="请填写标题" errormsg="请填写2-16个字符" />
                        </td>
                        <!-- 表单验证提示信息 -->
                        <td>
                            <div class="info">
                    ...
                    <tr>
                        ...
                        <td class="lh22">
                            <?php if(is_array($flags)): $i = 0; $__LIST__ = $flags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fl): $mod = ($i % 2 );++$i;?><label class="mgr4">
                                    <input class="pt3" name="flags[]" type="radio" value="<?php echo ($fl["att"]); ?>" <?php if(in_array(($fl["att"]), is_array($detail["flags"])?$detail["flags"]:explode(',',$detail["flags"]))): ?>checked="checked"<?php endif; ?> /><?php echo ($fl["attname"]); ?>[<?php echo ($fl["att"]); ?>]
                    ...
                    <!-- <tr>
                        ...
                        <td>
                            <input class="i400" name="" type="text" value="" />
                        </td>
                    </tr> -->
                    <!-- 描述 -->
                    <!-- <tr>
                        <td class="w120">描述：</td>
                        <td>
                            <textarea class="t400" name=""></textarea>
                        </td>
                    </tr> -->
                    <!-- 简介 -->
                    <tr>
                        <td class="w120">简介：</td>
                        <td>
                            <textarea class="t400" name="desc"><?php echo ($detail["desc"]); ?></textarea>
                        </td>
                    </tr>
                    <!-- 内容 -->
                    <tr>
                        <td class="w120">公告内容：</td>
                        <td>
                            <textarea id="notice_content" name="content"><?php echo ($detail["content"]); ?></textarea>
                        </td>
                    </tr>
                    <!-- 排序 -->
                    <tr>
                        <td class="w120">公告排序：</td>
                        <td>
                            <input class="i50" name="sort" type="text" value="<?php echo ((isset($detail["sort"]) && ($detail["sort"] !== ""))?($detail["sort"]):'50'); ?>" datatype="n" nullmsg="请填写数字" errormsg="请填写正确的数字" />
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="mgr">
                                <input class="pt3" type="radio" name="is_display" value="1" checked="checked"<?php if(($detail["is_display"]) == "1"): ?>checked="checked"<?php endif; ?> />
                                <span>显示</span>
                            </label>
                            <label>
                                <input class="pt3" type="radio" name="is_display" value="0" <?php if(($detail["is_display"]) == "0"): ?>checked="checked"<?php endif; ?> />
                                <span>不显示</span>
                            </label>
                        </td>
                    </tr>
