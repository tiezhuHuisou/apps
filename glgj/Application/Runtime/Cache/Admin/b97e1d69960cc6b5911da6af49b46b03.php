...
<body>
	...
	<!-- 主体 开始 -->
	<div class="main">
	<input id="url" type="hidden" value="?g=admin&m=index&a=regionsdelall">
		<div class="wrapper">
			<!-- 主体头部 -->
			<div class="header">
				<h2>省市区管理中心</h2>
				<a class="hover" href="?g=admin&m=index&a=regions">省市区列表</a>
				<a href="?g=admin&m=index&a=regionsadd">添加省市区</a>
			</div>
			<!-- 主体搜索 -->
			<div class="search">
				<form class="form-horizontal" name="" action="?g=admin&m=index&a=regions" method="post">
					<p>搜索：</p>
			...
			<table class="data">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					<td><input class="check_box" type="checkbox" name="items" value="<?php echo ($vo['id']); ?>" /></td>
					<td><?php echo ($vo['id']); ?></td>
					<td><?php echo ($vo['sty']); echo ($vo['name']); ?></td>
					<td><?php echo ($vo['grade']); ?></td>
					<td class="data_opt">
						<a href="?g=admin&m=index&a=regionsadd&id=<?php echo ($vo['id']); ?>">修改</a>
						<!-- <a class="confirm ajax-get" href="index.php?g=admin&m=index&a=regionsdel&id=<?php echo ($vo['id']); ?>">删除</a> -->
					</td>
				</tr><?php endforeach; endif; else: echo "" ;endif; ?>
			</table>
			<!-- 操作 -->
			<div class="opt">
				<a class="opt_btn" href="?g=admin&m=index&a=regionsadd">添加</a>
