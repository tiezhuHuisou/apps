...
class AddressModel extends Model{
    ...
    protected $_validate = array(
        ...
        array('province', 'require', '请选择省', self::MUST_VALIDATE),
        array('city', 'require', '请选择省', self::MUST_VALIDATE),
    ...
    protected $_auto = array (
        ...
        array('region','getRegion',Model::MODEL_BOTH,'callback'),
    );
    /**
     * 添加/编辑地址
