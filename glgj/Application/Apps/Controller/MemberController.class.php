...
class MemberController extends ApiController {
    ...
    protected function _initialize() {
        ...
        $memberInfo = M('Token')
            ->alias('l')
            ->field('l.uuid token,r.uid,r.gid,r.mphone,r.name username,r.head_pic,c.id company_id,c.name company_name,c.status company_status')
    ...
    public function index() {
        if (IS_GET) {
            ...
            if ($memberInfo['gid'] == 2) {
                $list['member_info']['identity'] = array(0 => 'http://glgj.m.huisou.com/data/upload/20150506/5549b16d94bdc.png', 1 => '企业会员');
            } else {
                $list['member_info']['identity'] = array(0 => '', 1 => '普通会员');
            }
            $list['member_info']['identity'] = $memberInfo['company_name'];
...
//            $refundNums = $refundNums > 0 ? strval($refundNums) : '';
            ...
            $toolsArray = array(
                ...
                array('title' => '物流收藏', 'icon' => $appPath . 'mine_company_collect.png', 'href' => 'company_collect', 'num' => ''),
                array('title' => '货车收藏', 'icon' => $appPath . 'mine_company_collect.png', 'href' => 'company_collect', 'num' => ''),
                array('title' => '货物收藏', 'icon' => $appPath . 'mine_company_collect.png', 'href' => 'company_collect', 'num' => ''),
                array('title' => '仓储收藏', 'icon' => $appPath . 'mine_company_collect.png', 'href' => 'company_collect', 'num' => ''),
...
//                array('title' => '收货地址', 'icon' => $appPath . 'mine_address.png', 'href' => 'address', 'num' => '')
            ...
            $list['section'] = array(
                array(
                    ...
                    'section_bottom' => '10',
                    'section_items' => array(
                        array('title' => '我的货车', 'icon' => $appPath . 'mine_wait_pay.png', 'href' => 'mineTruck', 'num' => ''),
                        array('title' => '我的仓储', 'icon' => $appPath . 'mine_wait_delivery.png', 'href' => 'mineDepot', 'num' => ''),
                        array('title' => '我的货物', 'icon' => $appPath . 'mine_wait_receive.png', 'href' => 'mineGoods', 'num' => ''),
                    ),
                ),
                array(
                ...
                array(
                    ...
                    'section_href' => '',
                    'section_bottom' => '10',
                    'section_items' => array('title' => '企业申请', 'icon' => $appPath . 'mine_company_home.png', 'href' => 'company_status', 'num' => ''),
                ),
                array(
                    'section_type' => 'row_four',
                    'section_title' => '更多服务',
