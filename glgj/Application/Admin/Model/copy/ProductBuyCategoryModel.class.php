...
use Think\Model;
class ProductBuyCategoryModel extends Model{
    /*自动验证*/
    protected $_validate = array(
        ...
        array('seo_description', '2,500', '描述长度为2-500位字符', self::VALUE_VALIDATE,'length'),
     ...
     */
    public function getProductBuyCategoryInfo($condition = array(),$field="*") {
     ...
     * @author 83961014@qq.com
     */
    public function delProductBuyCategory($condition){
